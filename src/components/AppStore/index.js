...
class AppStore extends Component {
  ...
  getFilteredApp = searchApp => {
    const {activeTabId} = this.state
    const filteredApp = searchApp.filter(
  ...
  render() {
    ...
    const searchResults = this.getSerachResults()
    const filteredApp = this.getFilteredApp(searchResults)
